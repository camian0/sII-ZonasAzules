...
class Place(Base):
    ...
    reservations = relationship(
        "Reservation", secondary="place_reservations", back_populates="places"
    )
    ...
    __table_args__ = (
        ForeignKeyConstraint(
            ["blue_zone_id"], ["blue_zones.id"], name="fk_places_blue_zone_id"
        ),
        ForeignKeyConstraint(
            ["place_state_id"], ["place_states.id"], name="fk_places_place_state_id"
        ),
        ForeignKeyConstraint(
            ["place_type_id"], ["place_types.id"], name="fk_places_place_type_id"
        ),
    )
